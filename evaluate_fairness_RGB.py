...
# ================================================================
# ĐIỀN CHÍNH XÁC TÊN RUN ĐÃ TRAIN CỦA BẠN VÀO ĐÂY
# ================================================================
# Ví dụ: "2024-05-12_15-30-00_V11_RGB_Fairness"
TRAINED_RUN_TIMESTAMP = "2026-04-15_17-07-38_V11_RGB_Fairness"

# ================================================================
# CẤU HÌNH & HÀM BỔ TRỢ (GIỮ NGUYÊN ĐỂ KHỚP VỚI LÚC TRAIN)
# ================================================================
class Config:
...
# ================================================================
# DATASET VÀ MODEL (GIỮ NGUYÊN ĐỂ ĐẢM BẢO KHỚP CODE GỐC)
# ================================================================
...
# ================================================================
# CHƯƠNG TRÌNH CHÍNH (ĐÁNH GIÁ ĐỘC LẬP)
# ================================================================
def main():
    ...
    logger.info("⏳ Đang chuẩn bị dữ liệu (Eval Mode)...")
    ...
    # TÁI TẠO LẠI CHÍNH XÁC TẬP TEST LÚC TRAIN 
    ...
    # LOAD ENSEMBLE MODELS TỪ FOLDER CHECKPOINTS
    ensemble_models = []
    ...
    if not ensemble_models:
        logger.error(f"❌ Không tìm thấy bất kỳ checkpoint nào của run '{TRAINED_RUN_TIMESTAMP}'. Hãy kiểm tra lại tên thư mục!")
        return
    ...
    logger.info("\n" + "="*70)
    logger.info(f"TỔNG QUAN ENSEMBLE (Tất cả các nhóm) | RMSE: {te_rmse:.4f} | MAE: {te_mae:.4f} | R²: {te_r2:.4f}")
