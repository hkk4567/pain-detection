...
# Cố gắng import từ file gốc (đảm bảo file gốc tên là gray_baseline.py)
try:
    from gray_baseline import (
    ...
    print("❌ Lỗi: Không tìm thấy file gray_baseline.py hoặc lỗi import.")
    print("Vui lòng đặt file này cùng thư mục với gray_baseline.py")
    exit(1)

# ==========================================
# CẤU HÌNH ĐÁNH GIÁ
# ==========================================
# TODO: Bạn CẦN thay đổi timestamp này thành timestamp của lần chạy bạn muốn đánh giá
TARGET_RUN_TIMESTAMP = "2026-04-15_11-21-45_GRAY_PureRaw_Baseline" 
