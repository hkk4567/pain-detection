...
# --- GIỮ NGUYÊN CÁC CLASS DATASET & MODEL TỪ RGB ---
...
def main(config):
    ...
    # Đã cập nhật eval transform cho RGB
    ...
    # Xáo tr��n danh sách Subject với cùng Seed cố định lúc huấn luyện
    ...
    # Lấy lại race trực tiếp bằng test_idx để chính xác hơn (vì batch_groups hiện lưu Subject ID thay vì ColorGroup)
    for idx in test_idx:
